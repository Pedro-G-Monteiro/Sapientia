...
const CourseCreationPage: React.FC = () => {
  ...
  const handleAddPrerequisite = () => {
    if (
      newPrerequisite &&
      !currentCourse.prerequisites.includes(newPrerequisite)
    ) {
      setCurrentCourse({
        ...currentCourse,
  ...
  const handleRemovePrerequisite = (prerequisite: string) => {
    setCurrentCourse({
      ...currentCourse,
      prerequisites: currentCourse.prerequisites.filter(
        (p) => p !== prerequisite
      ),
    });
  };
    ...
    moduleForm.validateFields().then((values) => {
      if (isEditingModule && currentModule) {
        ...
        const updatedModules = currentCourse.modules.map((module) =>
          module.id === currentModule.id ? { ...module, ...values } : module
        );
    ...
    return (
      <div className={styles.previewContainer}>
        <div className={styles.previewCard}>
          ...
          <div className={styles.previewContent}>
            ...
            <div className={styles.previewMeta}>
              <Tag
                color={
                  previewCourse.level === "Beginner"
                    ? "green"
                    : previewCourse.level === "Intermediate"
                    ? "blue"
                    : previewCourse.level === "Advanced"
                    ? "purple"
                    : "default"
                }
              >
              ...
              {!previewCourse.isPublished && <Tag color="orange">Draft</Tag>}
            </div>
          </div>
        </div>
        ...
        {currentCourse.modules.length > 0 ? (
          <Collapse
            defaultActiveKey={selectedModule ? [selectedModule] : undefined}
          >
              ...
              <Panel
                header={
                  <div className={styles.previewModuleHeader}>
                    ...
                    {!module.isPublished && (
                      <Tag color="orange" className={styles.draftTag}>
                        Draft
                      </Tag>
                    )}
                  </div>
                  ...
                  renderItem={(lesson) => (
                    <List.Item className={styles.previewLessonItem}>
                      <div className={styles.previewLessonContent}>
                        <VideoCameraOutlined
                          className={styles.previewLessonIcon}
                        />
                        <div>
                              ...
                              extra={
                                <Space>
                                  <Button
                                    ...
                                    icon={<PlusOutlined />}
                                    onClick={() =>
                                      handleAddLessonClick(module.id, index)
                                    }
                                  >
                                    Add Lesson
                                  </Button>
                                  ...
                                  {module.lessons.map((lesson, lessonIndex) => (
                                    ...
                                    >
                                      <div className={styles.lessonItem}>
                                        <div
                                          className={styles.lessonItemContent}
                                        >
                                          <DragOutlined
                    ...
                    <Row gutter={[32, 32]}>
                      <Col xs={24} md={12}>
                        <div className={styles.sectionContainer}>
                          ...
                          <div className={styles.listContainer}>
                            {currentCourse.prerequisites.map(
                              (prerequisite, index) => (
                      ...
                      <Col xs={24} md={12}>
                        <div className={styles.sectionContainer}>
                          ...
                          <Paragraph type="secondary">
                            What will students be able to do after taking this
                            course?
                          </Paragraph>
                      ...
                      <Col xs={24} md={12}>
                        ...
                        >
                          ...
                          >
                            ...
                            <Paragraph type="secondary">
                              When published, this course will be visible to all
                              users. If unpublished, it will be saved as a
                              draft.
                            </Paragraph>
                            ...
                            <Paragraph type="secondary">
                              Leave dates empty for permanent enrollment
                              availability.
                            </Paragraph>
                          </Form>
                        </Card>
                      ...
                      <Col xs={24} md={12}>
                        ...
                        >
                          ...
                          >
                            ...
                            <Paragraph type="secondary">
                              Free courses are available to all users. Premium
                              courses require a subscription or purchase.
                            </Paragraph>
                            ...
                            <Paragraph type="secondary">
                              Instructors who will be able to manage this
                              course.
                            </Paragraph>
                                    ...
                                    <Button
                                      ...
                                      onClick={() => {
                                        setCurrentCourse({
                                          ...currentCourse,
                                          instructors:
                                            currentCourse.instructors.filter(
                          ...
                          onClick={() => {
                            if (currentLesson) {
                              const updatedAttachments =
                                currentLesson.attachments.filter(
