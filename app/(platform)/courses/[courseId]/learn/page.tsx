...
const CourseLearningPage = () => {
        ...
        lessons: [
          {
            ...
            description:
              "Welcome to the course! In this lesson, we'll go over what you'll learn and how to get the most out of this course.",
            attachments: [
              {
                id: 1,
          ...
          },
          {
            ...
            description:
              "Learn how to set up your development environment for the course.",
          },
          {
            id: 103,
  ...
  const editNote = useCallback(
    (note: { id: number; text: string; timestamp: string }) => {
      setCurrentNote(note);
        ...
        <Content className={styles.lessonContent}>
          {currentLesson ? (
                      ...
                      children: (
                        <div className={styles.contentTab}>
                          ...
                          {currentLesson.description ? (
                            ...
                            <Paragraph className={styles.lessonDescription}>
                              This lesson doesn't have a detailed description
                              yet.
                            </Paragraph>
                          )}
                        ...
                        <div className={styles.notesTab}>
                          ...
                          {notes.length > 0 ? (
                            ...
                            <div className={styles.emptyNotes}>
                              <MessageOutlined
                                className={styles.emptyNotesIcon}
                              />
                              <Paragraph>
                                You haven't added any notes yet.
                              </Paragraph>
                              <Paragraph type="secondary">
                                Notes can help you remember important points
                                from the lesson.
                              </Paragraph>
                            </div>
                          )}
            ...
            <div className={styles.noLessonSelected}>
              ...
              <Paragraph>
                Please select a lesson from the course menu to start learning.
              </Paragraph>
            </div>
          )}
        </Content>
